...
class DepthwiseXCorr(nn.Module):
    def __init__(self, in_channels, hidden, out_channels, fused='none', kernel_size=3, hidden_kernel_size=5):
...
class DepthwiseRPN(RPN):
    def __init__(self, anchor_num=5, in_channels=256, out_channels=256, fused='none'):
